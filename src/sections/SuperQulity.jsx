...
const SuperQulity = () => {
  return (
    <section id="about-us" className=" flex justify-between items-center  max-lg:flex-col gap-10 w-ftll max-cantaom " >
      ...
      <div className="flex flex-1 flex-col">
        ...
        <h2 className="mt-10 font-palanquin text-4xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          ...
          <br /> 
          <span
          className="text-coral-red inline-block mt-3">Super Quality</span> Shoes
        </h2>
